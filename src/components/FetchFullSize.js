...
export default function FetchFullSize() {
    ...
    const renderCallback = (
        ...
        console.log("Id", id)
        console.log("Phase(Full Size):", phase)
        console.log("Actual duration(Full Size)", actualDuration)
      }
    
    
    return (
        <>
        <Profiler id='FullSize' onRender={renderCallback}> 
        <Box>       
        <Text mb='20px' align={'center'} fontWeight={'bold'} fontSize={'2xl'}>
           Fetch Full Size Images
        </Text>
        </Box>
        <ImageModal 
